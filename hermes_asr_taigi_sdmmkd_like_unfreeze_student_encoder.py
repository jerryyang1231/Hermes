...
"""
CUDA_VISIBLE_DEVICES=3 python -u hermes_asr_taigi_sdmmkd_like_unfreeze_student_encoder.py config/audio-text/hermes_asr_taigi_sdmmkd_like_unfreeze_student_encoder.yaml
"""
