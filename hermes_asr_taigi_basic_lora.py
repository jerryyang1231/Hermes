...
"""
CUDA_VISIBLE_DEVICES=2 python -u hermes_asr_taigi_basic_lora.py config/audio-text/hermes_asr_taigi_basic_lora.yaml
"""
...
class DistillWhisperModule(LightningModule):
    def __init__(self, cfg, model_name, lang) -> None:
        ...
        print("Initialized both Teacher from the same checkpoint.")
