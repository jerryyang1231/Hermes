...
"""
CUDA_VISIBLE_DEVICES=2 python -u hermes_asr_taigi_add_adapters_282_all_hiddens.py config/audio-text/hermes_asr_taigi_add_adapters_282_all_hiddens.yaml
"""
...
class DistillWhisperModule(LightningModule):
    ...
    def configure_optimizers(self):
        ...
        optimizer, scheduler = whisper_adapter_optimizer(self.student, self.cfg, self.t_total)
