...
"""
CUDA_VISIBLE_DEVICES=2 python -u hermes_asr_taigi_sdmmkd_like.py config/audio-text/hermes_asr_taigi_sdmmkd_like.yaml
"""
...
class DistillWhisperModule(LightningModule):
    def __init__(self, cfg, model_name, lang) -> None:
        ...
        # print("Applying LoRA to these decoder module names (full names):")
        # for nm in decoder_targets[:200]:
        #     print("  ", nm)
